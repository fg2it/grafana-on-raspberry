# Grafana v3.1.0-beta1 release for raspberry pi 2
Build from tag [v3.1.0-beta1](https://github.com/grafana/grafana/tree/v3.1.0-beta1) with
...
```bash
git checkout v3.1.0-beta1
```

## See:
- [fpm](https://github.com/jordansissel/fpm)
- [go](http://blog.hypriot.com/post/how-to-compile-go-on-arm/) by hypriot
- [grafana](https://github.com/grafana/grafana/blob/v3.1.0-beta1/docs/sources/project/building_from_source.md)
